 ...
 */
public class H265EncoderNode extends CodecNode {
    public H265EncoderNode(String name, int width, int height, int bit, int frameRate, int inputType, int outputType) {
        super(name, true, createFormat(width, height, bit, frameRate), inputType, outputType);
    }
