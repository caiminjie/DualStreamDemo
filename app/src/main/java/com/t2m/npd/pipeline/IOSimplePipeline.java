...
public class IOSimplePipeline<T extends Data> extends SimplePipeline<T> {
    ...
    @SuppressWarnings("unused")
    public IOSimplePipeline(String name, DataAdapter<T> adapter) {
        super(name, adapter);
    }

    @SuppressWarnings("unused")
    public IOSimplePipeline<T> addOutgoingNode(ProcessNode<T> node) {
    ...
    public IOSimplePipeline<T> addIncomingNode(ProcessNode<T> node) {
